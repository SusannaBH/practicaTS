...
//TODOS LOS ELEMENTOS
const bottonEl = document.getElementById('switch') as HTMLImageElement;
const [bombilla_1_El, bombilla_2_El] = document.getElementsByClassName('bombilla') as HTMLCollectionOf<HTMLImageElement>;
//const bombilla_1_El = bombillasEl[0] as HTMLImageElement;
//const bombilla_2_El = bombillasEl[1] as HTMLImageElement;
const lightEl = document.getElementById('barraLuminosidad') as HTMLInputElement;
const rotateEl = document.getElementById('barraRotacion') as HTMLInputElement;
const sizeEl = document.getElementById('barraTamaño') as HTMLInputElement;
